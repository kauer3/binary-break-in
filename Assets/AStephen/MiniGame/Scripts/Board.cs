...
public class Board : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        tryAgainButton.GetComponent<UnityEngine.UI.Button>().onClick.AddListener(() =>
        {
            tryAgainButton.SetActive(false);
            TryAgain();
        });

        newWordButton.GetComponent<UnityEngine.UI.Button>().onClick.AddListener(() =>
        {
    ...
    private void ShowNewWordButton()
    {
        tryAgainButton.SetActive(false);
        newWordButton.SetActive(true);
    }
